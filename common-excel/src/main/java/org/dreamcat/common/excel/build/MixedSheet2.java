...
public class MixedSheet2 implements IExcelSheet {
    ...
    public MixedSheet2(String name) {
        this(name, new ArrayList<>(0));
    }

    public MixedSheet2(String name, List schemes) {
        this.name = name;
        this.schemes = schemes;
    }

    public MixedSheet2(Class<?> clazz) {
        this(clazz.getName());
    ...
    public MixedSheet2(IExcelSheet header) {
        this(header.getName());
        schemes.add(header);
    }
