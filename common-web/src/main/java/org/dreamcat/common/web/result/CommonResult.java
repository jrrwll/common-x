...
public class CommonResult<T> {
    ...
    public static final CommonResult<?> OK = ok();
    ...
    public static <T, R> CommonResult<R> error(CommonResult<T> body) {
     ...
     */
    private static <T> CommonResult<T> create(int code, String msg, T data) {
